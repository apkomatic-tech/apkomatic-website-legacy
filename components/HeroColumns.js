    ...
    <Wrapper>
      <section className="featured">
        <section className="featured-row">
          <div className="centered" data-aos="fade-in">
            <h2>Design</h2>
            <p>
          ...
          <div className="featured__grid-item">
            <img className="img-fluid" src="/static/images/home/featured-design.svg" alt="design" />
          </div>
        </section>
        <section className="featured-row" data-aos="fade-in">
          ...
          <div className="left">
            <img className="img-fluid" src="/static/images/home/featured-code.svg" alt="development" />
          </div>
        </section>
        <section className="featured-row" data-aos="fade-in">
          <div className="centered">
            ...
            <p>
              ...
              {`'`}s why our work is not done after we build your product. We will keep in touch with you if you need
              help maintaining your website or web application. We value your time and business.
            </p>
          </div>
          <div>
            <img className="img-fluid" src="/static/images/home/featured-relationship.svg" alt="work ethic" />
          </div>
        </section>
      </section>
    </Wrapper>
