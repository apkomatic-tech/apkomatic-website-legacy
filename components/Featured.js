          ...
          <div className="container">
            <div className="row align-items-center">
              ...
              <div className="col-lg-6" data-aos="fade-left">
                ...
                <p>
                  No one likes slow and unresponsive websites or apps. We don
                  {"'"}t build them slow. We deliver websites and apps that are fast and optimized.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container">
            <div className="row align-items-center">
              <div className="col-lg-6" data-aos="fade-right">
                ...
                <p>
                  It
                  {`'`}s no secret that more websites and web apps are accessed using mobile devices. We build websites
            ...
            <div className="row align-items-center">
              ...
              <div className="col-lg-6" data-aos="fade-left">
                ...
                <p>
                  ...
                  {`'`}s why our work is not done after we build your product. We will keep in touch with you if you
                  need help maintaining your website or web application. We value your time and business.
                </p>
              </div>
            </div>
          </div>
